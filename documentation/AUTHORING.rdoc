...
or <tt>.callout.[style]</tt> as the first word of your paragraph.

[.callout] Highlights a paragraph with an outlined box.
[.callout.info] Adds an info icon.
[.callout.warning] Adds a warning icon.
[.callout.question] Adds a question icon.
[.callout.stop] Adds a stop icon.
